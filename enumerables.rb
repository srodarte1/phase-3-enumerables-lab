...
def print_spiciest_foods(spicy_foods)
  super_spicy_foods = spiciest_foods(spicy_foods)
  print_spicy_foods(super_spicy_foods)
end
...
def average_heat_level(spicy_foods)
  average_heat_level = spicy_foods.sum{|food| food[:heat_level]}
  average_heat_level / spicy_foods.length
end
